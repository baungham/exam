 ...
 * @version 1.0
 */
public class EnterpriseUpdateDialog extends JDialog {
	 ...
	 */
	public EnterpriseUpdateDialog(final EnterprisePanel enterprisePanel, final IEnterpriseService service) {
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						ee.setId(enterprise.getId());// 被修改的ID
	 ...
	 * @param selectId
	 */
	public void showInfo(int selectId) {
		enterprise = service.findById(selectId);
		

		textField.setText(enterprise.getName());
		textField_1.setText(enterprise.getAddress());
		editorPane.setText(enterprise.getDesc());
		
		int cityId = enterprise.getCityId(); 
		comboBox.setSelectedItem(new City(cityId));
